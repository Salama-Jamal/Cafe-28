      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-cream/80 leading-relaxed mb-4">
            Cafe 28 was born from a simple idea: bring a modern, relaxed
            coffee culture to Marrakech. Our space blends warm Moroccan
            hospitality with a contemporary atmosphere — a place to work,
            meet friends, or simply enjoy a great cup of coffee.
          </p>
          <p className="text-cream/80 leading-relaxed">
            Every drink is crafted with care, using quality ingredients and
            attention to detail, in a setting designed to make you feel at
            home.
          </p>
        </motion.div>
